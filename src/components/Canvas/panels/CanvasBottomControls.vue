<template>
  <div class="canvas__toolbar canvas__toolbar--bottom">
      ...
      <div class="canvas__zoom">
        <button type="button" class="canvas__tool-btn" title="缩小" @click="emit('zoom-out')">−</button>
        ...
        <button type="button" class="canvas__tool-btn" title="放大" @click="emit('zoom-in')">+</button>
      </div>
  </div>
</template>
